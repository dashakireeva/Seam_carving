...
def seam_carving(img, new_width=None, new_height=None, visualize=False):
    ...
    for iteration in range(delta_w):
        ...
        if visualize:
            ...
            # Combine all images into one panel
    ...
    if total_seams > 0:
        ...
        print(f"Seams removed: {total_seams}")
        print(f"Average time per seam: {total_time/total_seams:.4f} seconds")
        print(f"Processing speed: {total_seams/total_time:.2f} seams/second")
